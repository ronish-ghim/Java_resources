...
> *Source: Ronish's Java Lab Report — Samriddhi College*

This appendix contains **24 lab programs** covering the full Advanced Java Programming syllabus, organized by topic. Each lab includes Objective, Source Code, Output, and Conclusion.
...
- [Lab 1: Mouse Sum Diff](#lab-1-mouse-sum-diff) ← *Ch 3: Event Handling*
- [Lab 2: Add Two Numbers](#lab-2-add-two-numbers) ← *Ch 2: AWT & Swing*
- [Lab 3: Calculator Radio](#lab-3-calculator-radio) ← *Ch 2: AWT & Swing*
- [Lab 4: Sum Diff Adapter](#lab-4-sum-diff-adapter) ← *Ch 3: Event Handling*
- [Lab 5: Login GridLayout](#lab-5-login-gridlayout) ← *Ch 2: AWT & Swing*
- [Lab 6: Login GridBagLayout](#lab-6-login-gridbaglayout) ← *Ch 2: AWT & Swing*
- [Lab 7: Calculator BorderLayout](#lab-7-calculator-borderlayout) ← *Ch 2: AWT & Swing*
- [Lab 8a: Button Color](#lab-8a-button-color) ← *Ch 3: Event Handling*
- [Lab 8b: Form Background Color](#lab-8b-form-background-color) ← *Ch 3: Event Handling*
- [Lab 9: Layout Manager Demo](#lab-9-layout-manager-demo) ← *Ch 2: AWT & Swing*
- [Lab 10: Shape Drawer](#lab-10-shape-drawer) ← *Ch 2: AWT & Swing*
- [Lab 11: Color Changer Radio](#lab-11-color-changer-radio) ← *Ch 3: Event Handling*
- [Lab 12: Toolbar Icons](#lab-12-toolbar-icons) ← *Ch 2: AWT & Swing*

### Group B — JDBC (Labs 13–17)
- [Lab 13: JDBC Insert Students](#lab-13-jdbc-insert-students) ← *Ch 4: JDBC*
- [Lab 14: JDBC Update Salary](#lab-14-jdbc-update-salary) ← *Ch 4: JDBC*
- [Lab 15: JDBC Create Table](#lab-15-jdbc-create-table) ← *Ch 4: JDBC*
- [Lab 16: JDBC ResultSet Navigation](#lab-16-jdbc-resultset-navigation) ← *Ch 4: JDBC*
- [Lab 17: JDBC Updatable ResultSet](#lab-17-jdbc-updatable-resultset) ← *Ch 4: JDBC*

### Group C — Servlet / JSP (Labs 18–23)
- [Lab 18: Servlet Lifecycle](#lab-18-servlet-lifecycle) ← *Ch 7: Servlets & JSP*
- [Lab 19: Servlet Session](#lab-19-servlet-session) ← *Ch 7: Servlets & JSP*
- [Lab 20: Servlet Cookies](#lab-20-servlet-cookies) ← *Ch 7: Servlets & JSP*
- [Lab 21: JSP Cookies](#lab-21-jsp-cookies) ← *Ch 7: Servlets & JSP*
- [Lab 22: JSP Form Display](#lab-22-jsp-form-display) ← *Ch 7: Servlets & JSP*
- [Lab 23: JSP Simple Interest](#lab-23-jsp-simple-interest) ← *Ch 7: Servlets & JSP*

### Group D — RMI (Lab 24)
- [Lab 24: RMI Adder](#lab-24-rmi-adder) ← *Ch 8: RMI*

---

## Group A: AWT / Swing GUI

---

### Lab 1: Mouse Sum Diff

**Related Chapter:** [Ch 3: Event Handling](Chapter-03_Event-Handling.md)
...
**Related Chapter:** [Ch 2: AWT & Swing](Chapter-02_AWT-Swing.md)
...
**Related Chapter:** [Ch 4: JDBC](Chapter-04_JDBC.md)
...
**Related Chapter:** [Ch 7: Servlets & JSP](Chapter-07_Servlets.md)
...
**Related Chapter:** [Ch 8: RMI](Chapter-08_RMI.md)
